...
TEST(H264_BitStream, ReadAVCC2){
    char data[] =   "\x00\x00\x00\x00\x01\x4d\x40\x29\xff\xe1\x00\x1b\x67\x4d\x40\x29\xec\xa0\x60\x1b\xd3\x50\x10\xd0\x64\x00\x00\x03\x00\x04\x00\x00\x03\x00\xf2\x3c\x60\xc6\x58\x01\x00\x04\x68\xef\xbc\x80";
    char data2[]=   "";
    struct h264_avcc_data avcc_data,avcc_data2;
    bs_stream_t stream = bs_create( data, (sizeof data - 1) * 8, 0 );
    EXPECT_EQ( h264_read_avcc_data( stream, &avcc_data ), 0 );
    bs_destroy( stream );
    bs_stream_t stream2 = bs_create( data2, (sizeof data2 - 1) * 8, 0 );
    EXPECT_EQ( h264_read_avcc_data( stream2, &avcc_data2 ), 0 );
    bs_destroy( stream2 );
